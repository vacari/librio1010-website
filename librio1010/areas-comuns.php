...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Áreas Comuns - Studio Librio 1010 | Vila Mariana, SP</title>
    <meta name="description" content="Conheça as áreas comuns do condomínio Librio 1010: rooftop com piscina, academia, coworking, churrasqueira e muito mais na Vila Mariana.">
    <meta name="keywords" content="areas comuns vila mariana, rooftop piscina, academia condominio, coworking vila mariana, churrasqueira condominio">
    <meta name="author" content="Viva Vila Mariana">
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://vivavilamariana.com.br/librio1010/areas-comuns">
    <meta property="og:title" content="Áreas Comuns - Studio Librio 1010">
    <meta property="og:description" content="Conheça as áreas comuns do condomínio Librio 1010 na Vila Mariana.">
    <meta property="og:image" content="https://vivavilamariana.com.br/librio1010/imagens_condominio/rooftop 20250121_112857.jpg">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://vivavilamariana.com.br/librio1010/areas-comuns">
    <meta property="twitter:title" content="Áreas Comuns - Studio Librio 1010">
    <meta property="twitter:description" content="Conheça as áreas comuns do condomínio Librio 1010 na Vila Mariana.">
    <meta property="twitter:image" content="https://vivavilamariana.com.br/librio1010/imagens_condominio/rooftop 20250121_112857.jpg">
...
<body>
        ...
        <nav class="nav">
            <div class="nav-container">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="areas-comuns.php" class="nav-link active">Áreas Comuns</a></li>
    ...
    <section class="page-header">
        <div class="container">
            <h1>Áreas Comuns</h1>
            <p>Descubra todas as comodidades do condomínio Librio 1010</p>
        </div>
    </section>
                ...
                <div class="area-content">
                    ...
                    <div class="area-features">
                        ...
                        <div class="area-feature">
                            ...
                            <p>Vista 360° da Vila Mariana</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">☀️</span>
                            <h4>Solarium</h4>
                            <p>Área para tomar sol</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="area-grid reverse">
                ...
                <div class="area-content">
                    ...
                    <p>Mantenha-se em forma sem sair do condomínio. Nossa academia está equipada com aparelhos modernos para todos os tipos de treino.</p>
                    
                    <div class="area-features">
                        <div class="area-feature">
                            <span class="feature-icon">💪</span>
                            <h4>Musculação</h4>
                            <p>Aparelhos para força</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🏃‍♀️</span>
                            <h4>Cardio</h4>
                            <p>Esteiras e bicicletas</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🕐</span>
                            <h4>24h</h4>
            ...
            <div class="area-grid">
                <div class="area-content">
                    ...
                    <div class="area-features">
                        ...
                        <div class="area-feature">
                            <span class="feature-icon">🪑</span>
                            <h4>Móveis Ergonômicos</h4>
                            <p>Conforto para trabalhar</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🥤</span>
                            <h4>Frigobar</h4>
                            <p>Bebidas e lanches</p>
                        </div>
                    </div>
                </div>
                <div class="area-image">
    ...
    <section class="common-area-section light">
        <div class="container">
            <div class="area-grid reverse">
                ...
                <div class="area-content">
                    <h2>Churrasqueira</h2>
                    <p>Organize churrascos e encontros com amigos em nossa churrasqueira equipada. Local ideal para confraternizações e eventos.</p>
                    
                    <div class="area-features">
                        <div class="area-feature">
                            <span class="feature-icon">🔥</span>
                            <h4>Churrasqueira</h4>
                            <p>Equipada e funcional</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🧊</span>
                            <h4>Geladeira</h4>
                            <p>Para bebidas e alimentos</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🪑</span>
                            <h4>Área de Convivência</h4>
                            <p>Móveis para conforto</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="common-area-section light">
        <div class="container">
            <div class="area-grid reverse">
                ...
                <div class="area-content">
                    <h2>Playground e Horta</h2>
                    <p>Área verde com playground para crianças e horta comunitária. Conecte-se com a natureza sem sair do condomínio.</p>
                    
                    <div class="area-features">
                        <div class="area-feature">
                            <span class="feature-icon">🌱</span>
                            <h4>Horta Comunitária</h4>
                            <p>Cultive seus temperos</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🎠</span>
                            <h4>Playground</h4>
                            <p>Diversão para crianças</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🐕</span>
                            <h4>Pet Place</h4>
            ...
            <div class="area-grid">
                <div class="area-content">
                    ...
                    <div class="area-features">
                        ...
                        <div class="area-feature">
                            <span class="feature-icon">🏢</span>
                            <h4>Saguão Elegante</h4>
                            <p>Ambiente sofisticado</p>
                        </div>
                        <div class="area-feature">
                            <span class="feature-icon">🔒</span>
                            <h4>Segurança</h4>
    ...
    <section class="cta">
        <div class="container">
            <div class="cta-content">
                <h2>Gostou das Áreas Comuns?</h2>
                <p>Venha conhecer pessoalmente e reserve seu studio na Vila Mariana</p>
